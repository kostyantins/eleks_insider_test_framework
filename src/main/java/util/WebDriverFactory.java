...
public class WebDriverFactory {
    ...
    static void setDriver(final String browser, final String version, final String platform) throws MalformedURLException {
        ...
        if (driver == null) {
            ...
            final String chromeDriverMac = PropertiesReader.getProperty("chrome.driver_mac.name");
            final String chromeDriverMacPath = PropertiesReader.getProperty("chrome.driver_mac.path");

            final String ieDriver = PropertiesReader.getProperty("ie.driver.name");
            final String ieDriverPath = PropertiesReader.getProperty("ie.driver.path");
                    ...
                    switch (propertyBrowserTypeEnum) {  //Switching browser if using property
                        ...
                        case CHROME:
                            ...
                            driver = new ThreadLocal<WebDriver>() {
                                @Override
                                protected WebDriver initialValue() {
                                    System.setProperty(chromeDriverMac, chromeDriverMacPath);
                                    return new ChromeDriver();
                                }
                            };
                            break;
